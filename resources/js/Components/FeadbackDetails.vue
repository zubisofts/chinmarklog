        ...
        <div class="bg-white py-3 px-4">
            <header class="grid grid-cols-10">
                ...
                <aside class="col-span-8 lg:col-span-9 text-gray-900">
                    <p class="mb-1"> <font-awesome-icon :icon="['far', 'user']" /> {{ feedback.fulname }}</p>
            ...
            <header class="bg-gray-200 my-3 text-center py-2 px-2">
                <strong>
                    {{ feedback.subject }}
                </strong>
            </header>

            <div class="py-3 px-4" style="min-height:200px;">
                {{ feedback.message }}
            </div>
        </div>
