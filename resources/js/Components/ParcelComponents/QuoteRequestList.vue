...
<div class="max-w-7xl mx-auto sm:px-6">
    ...
    <div class="py-3" v-else>
        <quote-feadback-details :feedback-data="feedback" @showContactList="showList()"></quote-feadback-details>
    </div>
    </div>
</div>
</template>
...
import QuoteFeadbackDetails from './QuoteFeadbackDetails'; 

export default {
props: {},
components: {QuoteFeadbackDetails},
data() {
    return {
    contacts: [],
    action:false, 
...
methods: {
    fetchContactList() {
    var url = "/parcel/fetch_quote_request";
    HttpClient.client
